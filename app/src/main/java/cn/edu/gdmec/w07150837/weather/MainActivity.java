...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initProvinces();
        initChooseDialog();
//        Log.d("test",cityMap.get("provinceName")+"  provinceName");
//        Log.d("test", cityMap.get("cityName") + "  cityName");
        ...
        new GetWeatherInfoTask(this).execute("潮州");
    }
...
//                Log.d("test", cityMap.get(province_name) + "aaaa");
//                Log.d("test", cityMap.get("cityName") + "cityName");
